  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_number_frac() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, chars) { return "." + chars.join("")+frac; })(pos0, result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_ident_list() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            result2 = [];
            result3 = parse_comma_identifier();
            while (result3 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, first, rest) { return [first].concat(rest); })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_arglist() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            result2 = [];
            result3 = parse_comma_expression();
            while (result3 !== null) {
              result2.push(result3);
              result3 = parse_comma_expression();
            }
      ...
      function parse_statements() {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, v, body) { return {tag:"define", name:v, args:[], body:body}; })(pos0, result0[2], result0[9]);
            }
            if (result0 === null) {
              pos = pos0;
            }
